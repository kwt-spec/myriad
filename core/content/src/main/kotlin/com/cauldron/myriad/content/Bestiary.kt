...
object Bestiary {
    ...
    private val ARCHETYPES = listOf(
        Archetype("rat", "cinder rat", 9, 3, 1, 85, "dagger",
        ...
        Archetype("wisp", "wisp", 6, 2, 0, 135, "staff",
        ...
        Archetype("hound", "ash hound", 15, 4, 2, 110, "sword",
            ...
            listOf(mv("snap", "snap", "It lunges, jaws wide and smoking.", 10, 10, 3),
                   mv("maul", "maul", "It drops its shoulder to bowl you down.", 14, 10, 2))),
        Archetype("crawler", "ember crawler", 18, 3, 2, 80, "spear",
            ...
            listOf(mv("skitter", "skitter-bite", "Its legs blur as it scuttles in.", 9, 10, 3),
                   mv("spew", "ember spew", "Its abdomen swells, glowing from within.", 15, 10, 1))),
        Archetype("wraith", "ash wraith", 11, 5, 0, 115, "staff",
            ...
            listOf(mv("rake", "spectral rake", "It reaches through the air toward you.", 11, 10, 3),
                   mv("wail", "ember wail", "Its formless face splits in a soundless cry.", 16, 10, 1))),
        Archetype("golem", "slag golem", 32, 4, 4, 60, "mace",
        ...
        Archetype("serpent", "cinder serpent", 16, 4, 2, 120, "whip",
        ...
        Archetype("swarm", "ember swarm", 13, 2, 0, 125, "flail",
        ...
        Archetype("brute", "soot brute", 28, 6, 3, 85, "warhammer",
        ...
        Archetype("stalker", "dark stalker", 14, 5, 1, 130, "dagger",
            "A lean shape that keeps to the edge of the firelight, watching.",
            listOf(mv("ambush", "ambush", "It tenses, weight shifting onto its toes.", 11, 10, 3),
                   mv("eviscerate", "eviscerate", "It flips its blades into a reverse grip.", 17, 10, 1))),
        Archetype("knight", "cinder knight", 30, 5, 5, 95, "sword",
        ...
        Archetype("maw", "gaping maw", 23, 6, 2, 100, "axe",
            "Mostly mouth — a floor-bound devourer ringed with inward teeth.",
            listOf(mv("bite", "engulfing bite", "The maw yawns impossibly wide.", 13, 10, 3),
                   mv("swallow", "swallow whole", "It lunges to drag you in.", 18, 10, 1))),
        Archetype("shade", "pyre shade", 12, 6, 0, 125, "scythe",
            "A tall, thin darkness with two coals for eyes and a reaper's patience.",
            listOf(mv("reap", "reaping sweep", "It draws a long arm back like a scythe.", 12, 10, 3),
                   mv("chill", "grave chill", "The air around it dims and cools.", 15, 10, 1))),
        Archetype("drake", "ember drake", 36, 7, 4, 115, "cleaver",
            "A low, wingless drake whose every breath glows in its throat.",
            listOf(mv("rend", "rending claw", "It plants its feet and rakes the air.", 13, 10, 3),
                   mv("breath", "ember breath", "Its throat kindles to a furnace roar.", 19, 10, 2))),
    )
    ...
    fun all(allItems: Map<ItemId, ItemDef>): Map<MonsterId, MonsterDef> {
        ...
        for (arch in ARCHETYPES) for (cond in CONDITIONS) for (tier in TIERS) {
            ...
            val atk = arch.atk + tier.index * 3 / 2 + cond.atkAdd
            val def = arch.def + tier.index / 3
